/**
 * quiz.js — MartialGuide Quiz functionality
 * Handles 5-step quiz with slider questions and scoring algorithm
 */
...
function scoreArt(art) {
    ...
    // 1. FITNESS vs FITNESS REQUIRED (max 25)
    ...
    // 4. BUDGET vs TOTAL EQUIPMENT COST (max 20)
    ...
    // 5. DIFFICULTY PENALTY if user has low fitness (max -15)
